...
class EducationQueryDetailScreen extends StatefulWidget {
  ...
  const EducationQueryDetailScreen({super.key, required this.queryDoc});
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text(t('Education Query Details')),
                      ...
                      child: Padding(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _info(t('Topic'), (data['topic'] ?? '-').toString()),
                            _info(t('Class'), (data['studentClass'] ?? '-').toString()),
                            _info(
                              t('Assigned To'),
